...
export function AnnotationOverlay({
	...
	const renderArrow = () => {
		...
		const color = annotation.figureData?.color || "#B6410F";
	...
	return (
		<Rnd
			...
			style={{
				...
				pointerEvents: "auto",
				border: isSelected ? "2px solid rgba(182, 65, 15, 0.8)" : "none",
				backgroundColor: isSelected ? "rgba(182, 65, 15, 0.1)" : "transparent",
				boxShadow: isSelected ? "0 0 0 1px rgba(182, 65, 15, 0.35)" : "none",
			}}
			...
			resizeHandleStyles={{
				topLeft: {
					...
					border: isSelected ? "2px solid #B6410F" : "none",
					borderRadius: "50%",
					left: "-6px",
					top: "-6px",
					cursor: "nwse-resize",
