...
export default function PlaybackCursor({
	...
	return (
		...
		>
			<div
				className="absolute top-0 bottom-0 w-[2px] bg-primary shadow-[0_0_10px_rgba(182,65,15,0.5)] cursor-ew-resize pointer-events-auto hover:shadow-[0_0_15px_rgba(182,65,15,0.7)] transition-shadow"
