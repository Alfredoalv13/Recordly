					...
					return (
						<button
							...
							className={cn(
								...
								isActive &&
									"border-primary/70 bg-primary/12 shadow-[inset_0_0_0_1px_rgba(182,65,15,0.15)]",
							)}
						>
		...
		const settingsSectionContent = (
			<div className="space-y-4">
				...
				{showDevMotionControls ? (
					<section className="flex flex-col gap-2 rounded-xl border border-primary/15 bg-primary/5 p-3">
						<div className="flex items-center justify-between gap-3">
							<div>
								<SectionLabel>
						...
						<div className="rounded-lg border border-foreground/10 bg-background/60 px-3 py-3">
							<div className="flex items-start justify-between gap-3">
								...
								<Button
									...
									className="h-8 shrink-0 border-primary/20 bg-primary/10 text-primary hover:bg-primary/15"
								>
