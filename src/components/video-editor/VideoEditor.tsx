...
export default function VideoEditor() {
	...
	return (
		<div className="flex flex-col h-screen bg-editor-bg text-foreground overflow-hidden selection:bg-primary/30">
			<div
					...
					>
						<DropdownMenuTrigger asChild>
							<Button
								...
								className="inline-flex h-8 min-w-[112px] items-center justify-center gap-2 rounded-[5px] bg-primary px-4.5 text-white transition-colors hover:bg-primary/90"
							>
									...
									<div className="mt-4 flex gap-2">
										{hasPendingExportSave ? (
											<Button
												...
												className="h-8 flex-1 rounded-[5px] bg-primary text-xs font-semibold text-white hover:bg-primary/90"
											>
							...
							<div className="z-10 ml-auto flex items-center gap-2">
								<div className="flex items-center gap-1.5">
									...
									<div className="relative flex h-7 w-24 select-none items-center overflow-hidden rounded-full border border-foreground/[0.06] bg-editor-bg/80 shadow-[inset_0_1px_0_hsl(var(--foreground)/0.06)]">
										...
										/>
										<div
											className="pointer-events-none absolute bottom-[18%] top-[18%] z-10 w-[2px] rounded-full bg-foreground/95 shadow-[0_0_10px_rgba(182,65,15,0.28)]"
