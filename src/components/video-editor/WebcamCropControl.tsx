...
export function WebcamCropControl({
	...
	return (
		...
		>
			...
			<div
				className={cn(
					"absolute border border-white shadow-[0_0_0_1px_rgba(182,65,15,0.9),0_8px_24px_rgba(0,0,0,0.25)] focus:outline-none focus:ring-2 focus:ring-primary/60 focus:ring-offset-2 focus:ring-offset-editor-dialog",
